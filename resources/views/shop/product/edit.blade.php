            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title"><i class="fa fa-edit"></i>
                        {{ strtoupper($product->reg_no) . ' - ' . ucwords($product->product_name) }}
                    </h3>
                </div>
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
                                <form action="{{ route('shop.products.update', $product->product_id) }}"
                                    ...
                                    <div class="modal-body">
                                        <fieldset class="border pb-3 pl-5 pr-5">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="outpost_id" class="form-control select2" id="outposts"
                                                            required>
                                                            <option class="mb-1"
                                                                value="{{ $product->outpost }}">
                                                                {{ $product->outpost_name }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="user_id" id="users" class="form-control select2"
                                                            id="user_id" required>
                                                            <option class="mb-1"
                                                                value="{{ $product->officer }}">
                                                                {{ $product->user_name }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type" id="type" class="form-control select2" id="type"
                                                            required>
                                                            <option class="mb-1" value="{{ $product->type }}">
                                                                {{ $product->type_name }}</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="image">Image (800X500) <a target="_new"
                                                                href="{{ asset('storage/assets/app/images/products/' . $product->images) }}"><span
                                                                    style="font-style: italic">View Existing
                                                                    Image</span></a></label>
                                                        <div class="form-group">
