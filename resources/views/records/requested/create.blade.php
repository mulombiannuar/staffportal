            ...
            <div class="card card-warning card-outline">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#form-request" data-toggle="tab"><i
                                    class="fa fa-user"></i>
                                {{ $title }}</a></li>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="outpost" class="form-control select2"
