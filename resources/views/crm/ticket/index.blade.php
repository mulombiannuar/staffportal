        ...
        <div class="card card-warning card-outline">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#online-loans" data-toggle="tab"><i
                                class="fa fa-list"></i>
                            Online Loans({{ count($online_loans) }})</a></li>
            ...
            <div class="card-body">
                <div class="tab-content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="margin">
                                                            <div class="btn-group">
                                                                <a
                                                                    href="{{ route('crm.tickets.edit', $ticket->ticket_id) }}">
                    ...
                    <div class="tab-pane" id="online-loans">
                        <!-- All -->
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fa fa-users"></i> Online Loan Application</h3>
                            </div>
                            <div class="card-body">
                                <table id="table4" class="table table-sm table-bordered table-striped table-head-fixed">
                                    <thead>
                                        <tr>
                                            <th>S.N</th>
                                            <th>TICKET ID</th>
                                    ...
                                    <tbody>
                                        @foreach ($online_loans as $ticket)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $ticket->ticket_uuid }}</td>
                                                <td>{{ $ticket->category_name }}</td>
