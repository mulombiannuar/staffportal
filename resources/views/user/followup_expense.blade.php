            ...
            <div class="card-body">
              <div class="tab-content">
                <div class="tab-pane active" id="details">
                  ...
                  <div class="card card-warning">
                    <div class="card-header">
                      <h3 class="card-title"><i class="fa fa-user"></i> Followup Details</h3>
                    </div>
                    <div class="card-body">
                      <div class="container-fluid">
                        @if (!empty($followupData))
                        <form role="form" method="post"
                          action="{{ route('user.followups.update', $followupData->followup_id) }}"
                            ...
                            <div class="row">
                              <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                  <label for="clients">Groups/Clients Followed up</label>
                                  <textarea placeholder="Enter group/clients being followed up separated by commas"
                                    name="clients" id="clients" class="form-control" required cols="2"
                                    rows="2">{{ $followupData->clients }}</textarea>
                                </div>
                              </div>
                              <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                  <label for="additional_info">Purpose of the Followup</label>
                                  <textarea placeholder="Enter detailed purpose of this activity" name="additional_info"
                                    ...
                                    rows="2">{{ $followupData->additional_info }}</textarea>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="journey_from" class="form-control" id="journey_from"
                                    placeholder="Enter starting point" value="{{ $followupData->journey_from }}"
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="venue" class="form-control" id="venue"
                                    placeholder="Enter venue of Followup" value="{{ $followupData->venue }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="time" name="starting_time" class="form-control" id="starting_time"
                                    placeholder="Enter starting time" value="{{ $followupData->start_time }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="time" name="ending_time" class="form-control" id="ending_time"
                                    placeholder="Enter ending time" value="{{ $followupData->end_time }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="date" name="date" class="form-control" id="date"
                                    placeholder="Date of Visit" value="{{ $followupData->date }}" autocomplete="off"
                                    required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input disabled type="text" class="form-control" id="transport_means"
                                    ...
                                    value="{{ $followupData->transport_means == 1? 'Public' : 'Private' }} Transport"
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="amount_spent" class="form-control" id="amount_spent"
                                    ...
                                    value="{{ $followupData->amount_spent }}" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="mileage_before" class="form-control" id="mileage_before"
                                    ...
                                    value="{{ $followupData->mileage_before }}" autocomplete="off">
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="mileage_after" class="form-control" id="mileage_after"
                                    ...
                                    value="{{ $followupData->mileage_after }}" autocomplete="off">
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="fuel_consumption" class="form-control"
                                    ...
                                    value="{{ $followupData->fuel_consumption }}" autocomplete="off">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="amount_collected" class="form-control"
                                    id="amount_collected" placeholder="Enter total amount spent" autocomplete="off"
                                    value="{{ $followupData->amount_collected }}" required>
                                </div>
                              </div>
                            </div>
                            @endif
                          </div>
                          @if (is_null($expense->approver1) && Auth::user()->id == $followupData->user_id)
                          <div class="modal-footer justify-content-between">
                            <button type="submit" class="btn btn-primary"> <i class="fa fa-edit"></i>
                              Update Followup Data</button>
                          </div>
                          @endif
                          <!-- /.card-body -->
                        </form>
                        ...
                        <div class="modal-footer justify-content-between">
                          <div class="btn-group">
                            <form action="{{ route('user.followups.destroy', $followupData->followup_id) }}"
                              method="post"
                              onclick="return confirm('Do you really want to delete this Followup data?')">
                              @csrf
                              @method('DELETE')
                              <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i>
                                Delete Followup Data</button>
                            </form>
                          </div>
                        </div>
                        @endif
                        ...
                        @endif
                        @else
                        <form role="form" method="post" action="{{ route('user.followups.store') }}"
                          enctype="multipart/form-data" accept-charset="utf-8">
                          @csrf
                          <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  <label for="venue">Client Location</label>
                                  <input type="text" name="venue" class="form-control" id="venue"
                                    placeholder="Enter venue of Followup" value="{{ old('venue') }}" autocomplete="on"
                                    required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                            ...
                            <div class="row">
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  <label for="amount_collected">Amount Collected</label>
                                  <input type="number" name="amount_collected" class="form-control"
                                    id="amount_collected" placeholder="Enter total amount collected" autocomplete="off"
                                    value="{{ old('amount_collected') }}" required>
                                </div>
                              </div>
                            </div>
                          </div>
