                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="national_id" class="form-control"
                                                        id="national_id" placeholder="Enter national id" autocomplete="off"
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="address" class="form-control" id="address"
                                                        placeholder="Postal address" value="{{ old('address') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="county" id="county" class="form-control select2"
                                                        id="county" required>
                                                        <option class="mb-1" value="">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="sub_county" class="form-control select2" id="subs"
                                                        required>
                                                        <option class="mb-1" value="">
