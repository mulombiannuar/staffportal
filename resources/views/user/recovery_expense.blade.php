            ...
            <div class="card-body">
              <div class="tab-content">
                <div class="tab-pane active" id="details">
                  ...
                  <div class="card card-warning">
                    <div class="card-header">
                      <h3 class="card-title"><i class="fa fa-user"></i> Loan Recovery Details</h3>
                    </div>
                    <div class="card-body">
                      <div class="container-fluid">
                        @if (!empty($recoveryData))
                        <form role="form" method="post"
                          action="{{ route('user.loan-recoveries.update', $recoveryData->recovery_id) }}"
                          ...
                          <div class="card-body">
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="client_id" class="form-control" id="client_id"
                                    placeholder="Enter client id" value="{{ $recoveryData->client_id }}"
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="client_name" class="form-control" id="client_name"
                                    placeholder="Enter client name" value="{{ $recoveryData->client_name }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  <label for="client_phone">Client Mobile</label>
                                  <input type="number" name="client_phone" class="form-control" id="client_phone"
                                    placeholder="Enter client phone" value="{{ $recoveryData->client_phone }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  <label for="amount_collected">Amount Recovered</label>
                                  <input type="number" name="amount_collected" class="form-control"
                                    id="amount_collected" placeholder="Enter Amount Recovered"
                                    value="{{ $recoveryData->amount_collected }}" autocomplete="on" required>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="journey_from" class="form-control" id="journey_from"
                                    placeholder="Enter starting point" value="{{ $recoveryData->journey_from }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="venue" class="form-control" id="venue"
                                    placeholder="Enter venue of Loan Recovery" value="{{ $recoveryData->venue }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="time" name="starting_time" class="form-control" id="starting_time"
                                    placeholder="Enter starting time" value="{{ $recoveryData->start_time }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="time" name="ending_time" class="form-control" id="ending_time"
                                    placeholder="Enter ending time" value="{{ $recoveryData->end_time }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="date" name="date" class="form-control" id="date"
                                    placeholder="Date of Visit" value="{{ $recoveryData->date }}" autocomplete="off"
                                    required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input disabled type="text" class="form-control" id="transport_means"
                                    ...
                                    value="{{ $recoveryData->transport_means == 1? 'Public' : 'Private' }} Transport"
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="amount_spent" class="form-control" id="amount_spent"
                                    ...
                                    value="{{ $recoveryData->amount_spent }}" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="mileage_before" class="form-control" id="mileage_before"
                                    ...
                                    value="{{ $recoveryData->mileage_before }}" autocomplete="off">
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="mileage_after" class="form-control" id="mileage_after"
                                    ...
                                    value="{{ $recoveryData->mileage_after }}" autocomplete="off">
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="fuel_consumption" class="form-control"
                                    ...
                                    value="{{ $recoveryData->fuel_consumption }}" autocomplete="off">
                                </div>
                              </div>
                            </div>
                            @endif
                            <div class="row">
                              <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                  <label for="additional_info">Purpose of the Loan Recovery</label>
                                  <textarea placeholder="Enter detailed purpose of this activity" name="additional_info"
                                    ...
                                    rows="2">{{ $recoveryData->additional_info }}</textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                          @if (is_null($expense->approver1) && Auth::user()->id == $recoveryData->user_id)
                          <div class="modal-footer justify-content-between">
                            <button type="submit" class="btn btn-primary"> <i class="fa fa-edit"></i>
                              Update Loan Recovery Data</button>
                          </div>
                          @endif
                          <!-- /.card-body -->
                        </form>
                        ...
                        <div class="modal-footer justify-content-between">
                          <div class="btn-group">
                            <form action="{{ route('user.loan-recoveries.destroy', $recoveryData->recovery_id) }}"
                              method="post"
                              onclick="return confirm('Do you really want to delete this Loan Recovery data?')">
                              @csrf
                              @method('DELETE')
                              <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i>
                                Delete Loan Recovery Data</button>
                            </form>
                          </div>
                        </div>
                        @endif
                        ...
                        @endif
                        @else
                        <form role="form" method="post" action="{{ route('user.loan-recoveries.store') }}"
                          enctype="multipart/form-data" accept-charset="utf-8">
                          @csrf
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="client_id" class="form-control" id="client_id"
                                    placeholder="Enter client id" value="{{ old('client_id') }}" autocomplete="on"
                                    required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  <label for="client_name">Client Name</label>
                                  <input type="text" name="client_name" class="form-control" id="client_name"
                                    placeholder="Enter client name" value="{{ old('client_name') }}" autocomplete="on"
                                    required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  <label for="client_phone">Client Mobile</label>
                                  <input type="number" name="client_phone" class="form-control" id="client_phone"
                                    placeholder="Enter client phone" value="{{ old('client_phone') }}" autocomplete="on"
                                    required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="amount_collected" class="form-control"
                                    id="amount_collected" placeholder="Enter Amount Recovered"
                                    value="{{ old('amount_collected') }}" autocomplete="on" required>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              ...
                              <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                  <label for="venue">Client Location</label>
                                  <input type="text" name="venue" class="form-control" id="venue"
                                    placeholder="Enter venue of Loan Recovery" value="{{ old('venue') }}"
                                    autocomplete="on" required>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-6">
                          ...
                          <div class="modal-footer justify-content-between">
                            <button type="submit" class="btn btn-primary"> <i class="fa fa-plus"></i>
                              Save Loan Recovery Data</button>
                          </div>
                          <!-- /.card-body -->
                        </form>
                        @endif
