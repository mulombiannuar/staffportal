    ...
    <section class="content">
        <div class="container-fluid">
            <div class="margin mb-2 text-right">
                <a href="{{ route('admin.printers.create') }}">
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Printer</button>
                </a>
            </div>
                            ...
                            @foreach ($assets as $asset)
                                <tr>
                                    ...
                                    <td>
                                        <div class="margin">
                                            <div class="btn-group">
                                                <a href="{{ route('admin.printers.edit', $asset->printer_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('admin.printers.show', $asset->printer_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <form action="{{ route('admin.printers.destroy', $asset->printer_id) }}"
                                                    method="post"
