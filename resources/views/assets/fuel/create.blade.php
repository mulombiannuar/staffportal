                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name"
                                                        value="{{ old('name') }}" placeholder="Enter mobile phone name"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="imei_number" class="form-control"
                                                        id="imei_number" value="{{ old('imei_number') }}"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="pin_1" class="form-control" id="pin_1"
                                                        value="{{ old('pin_1') }}" placeholder="Enter pin 1"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="pin_2" class="form-control" id="pin_2"
                                                        value="{{ old('pin_2') }}" placeholder="Enter pin 2"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="puk_1" class="form-control" id="puk_1"
                                                        value="{{ old('puk_1') }}" placeholder="Enter puk 1"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="puk_2" class="form-control" id="puk_2"
                                                        value="{{ old('puk_2') }}" placeholder="Enter puk 2"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                        </div>
