            ...
            <div class="card card-warning">
                ...
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
                                <form action="{{ route('admin.phones.update', $asset->phone_id) }}" method="post">
                                    @method('PUT')
                                    @csrf
                                    <div class="modal-body">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name"
                                                        value="{{ $asset->name }}" placeholder="Enter mobile phone name"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="imei_number" class="form-control"
                                                        id="imei_number" value="{{ $asset->imei_number }}"
                                                        placeholder="Enter imei number" autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="phone_number" class="form-control"
                                                        id="phone_number" value="{{ $asset->phone_number }}"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="pin_1">PIN 1</label>
                                                    <input type="number" name="pin_1" class="form-control" id="pin_1"
                                                        value="{{ $asset->pin_1 }}" placeholder="Enter pin 1"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="pin_2">PIN 2</label>
                                                    <input type="number" name="pin_2" class="form-control" id="pin_2"
                                                        value="{{ $asset->pin_2 }}" placeholder="Enter pin 2"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="puk_1">PUK 1</label>
                                                    <input type="number" name="puk_1" class="form-control" id="puk_1"
                                                        value="{{ $asset->puk_1 }}" placeholder="Enter puk 1"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="puk_2">PUK 2</label>
                                                    <input type="number" name="puk_2" class="form-control" id="puk_2"
                                                        value="{{ $asset->puk_2 }}" placeholder="Enter puk 2"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                        </div>
