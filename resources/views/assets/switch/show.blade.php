                                ...
                                <div class="card-body">
                                    <div class="modal-body">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name"
                                                        value="{{ $asset->name }}" placeholder="Enter Router name"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="date_purchased">Date Of Purschase</label>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="model_no" class="form-control" id="model_no"
                                                        value="{{ $asset->model_no }}" placeholder="Enter model no"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="location" class="form-control" id="location"
                                                        value="{{ $asset->location }}" placeholder="Enter location "
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                            ...
                            <div class="card card-warning">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.assets.assign') }}" method="post">
                                        ...
                                        <input type="hidden" name="asset_id" value="{{ $asset->switch_id }}">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm-3">
