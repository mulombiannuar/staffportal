    ...
    <section class="content">
        <div class="container-fluid">
            <div class="margin mb-2 text-right">
                <a href="{{ route('admin.switches.create') }}">
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Switch</button>
                </a>
            </div>
                            ...
                            @foreach ($assets as $asset)
                                <tr>
                                    ...
                                    <td>
                                        <div class="margin">
                                            <div class="btn-group">
                                                <a href="{{ route('admin.switches.edit', $asset->switch_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('admin.switches.show', $asset->switch_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <form action="{{ route('admin.switches.destroy', $asset->switch_id) }}"
                                                    method="post"
