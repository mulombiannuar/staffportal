        ...
        <div class="container-fluid">
            <div class="card card-warning">
                ...
                <div class="card-body container">
                    <form class="form-horizontal" method="post" action="{{ route('admin.logs.update', $log->log_id) }}">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_done" class="form-control" id="date_done"
                                        value="{{ $log->date_done }}" placeholder="Select date done" autocomplete="on"
                                        required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cost" class="form-control" id="cost"
                                        value="{{ $log->cost }}" placeholder="Enter maintenance cost" autocomplete="on"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="hdw_log_status" name="hdw_log_status"
                                        required="required"
                                        placeholder="Describe the Hardware logs check findings/status of the device here.......">{{ $log->hdw_log_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="hdw_log_comment" name="hdw_log_comment"
                                        required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->hdw_log_comment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="hdd_cleanup_status"
                                        ...
                                        placeholder="Describe the Hard disk clean up findings/status of the device here.......">{{ $log->hdd_cleanup_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="hdd_cleanup_comment"
                                        name="hdd_cleanup_comment" required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->hdd_cleanup_comment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="hdd_capacity_status"
                                        ...
                                        placeholder="Describe the Hard disk capacity check findings/status of the device here.......">{{ $log->hdd_capacity_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="hdd_capacity_comment"
                                        name="hdd_capacity_comment" required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->hdd_capacity_comment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="hdw_tools_status" name="hdw_tools_status"
                                        required="required"
                                        placeholder="Describe the Hard disk capacity check findings/status of the device here.......">{{ $log->hdw_tools_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="hdw_tools_comment"
                                        name="hdw_tools_comment" required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->hdw_tools_comment }}</textarea>
                                </div>
                            </div>
                        </Fieldset>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="windows_update_status"
                                        ...
                                        placeholder="Describe the Windows update findings/status of the device here.......">{{ $log->windows_update_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="windows_update_comment"
                                        name="windows_update_comment" required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->windows_update_comment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="browser_status" name="browser_status"
                                        required="required"
                                        placeholder="Describe browser findings/status of the device here.......">{{ $log->browser_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="browser_comment" name="browser_comment"
                                        required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->browser_comment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="sftw_status" name="sftw_status"
                                        required="required"
                                        placeholder="Describe the Software logs check findings/status of the device here.......">{{ $log->sftw_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="sftw_comment" name="sftw_comment"
                                        required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->sftw_comment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="antivirus_status" name="antivirus_status"
                                        required="required"
                                        placeholder="Describe the Hard disk capacity check findings/status of the device here.......">{{ $log->antivirus_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="antivirus_status" name="antivirus_comment"
                                        required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->antivirus_comment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="antivirus_log" name="antivirus_log"
                                        required="required"
                                        placeholder="Describe the Antivirus log check findings/status of the device here.......">{{ $log->antivirus_log }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="antivirus_log_comment"
                                        name="antivirus_log_comment" required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->antivirus_log_comment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="security_log" name="security_log"
                                        required="required"
                                        placeholder="Describe the Security logs check findings/status of the device here.......">{{ $log->security_log }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="security_log_comment"
                                        name="security_log_comment" required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->security_log_comment }}</textarea>
                                </div>
                            </div>
                        </Fieldset>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="backup_status" name="backup_status"
                                        required="required"
                                        placeholder="Describe the Files/folder backup findings/status of the device here.......">{{ $log->backup_status }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" id="backup_comment" name="backup_comment"
                                        required="required"
                                        placeholder="Describe comments and recommendations here ......">{{ $log->backup_comment }}</textarea>
                                </div>
                            </div>
                        </Fieldset>
                        <div class="card-footer justify-content-between">
                            <button type="submit" class="btn btn-info"> <i class="fa fa-user-edit"></i>
                                Update Maintenance Log Data</button>
                        </div>
                    </form>
                </div>
                <!-- /.card-body -->
