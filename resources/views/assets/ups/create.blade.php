            ...
            <div class="card card-warning">
                ...
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
                                <form action="{{ route('admin.ups.store') }}" method="post">
                                    @csrf
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name"
                                                        value="{{ old('name') }}" placeholder="Enter UPS name"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="battery_time" class="form-control"
                                                        id="battery_time" value="{{ old('battery_time') }}"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="input_capacity" class="form-control"
                                                        id="input_capacity" value="{{ old('input_capacity') }}"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="output_capacity" class="form-control"
                                                        id="output_capacity" value="{{ old('output_capacity') }}"
