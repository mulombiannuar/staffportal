                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name"
                                                        value="{{ $asset->name }}" placeholder="Enter Laptop name"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="display" class="form-control" id="ram"
                                                        value="{{ $asset->display }}" placeholder="Enter display details"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                            ...
                            <div class="card card-warning">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.assets.assign') }}" method="post">
                                        ...
                                        <input type="hidden" name="asset_id" value="{{ $asset->laptop_id }}">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm-3">
                            ...
                            <div class="card card-warning">
                                ...
                                <div class="card-body">
                                    <div class="margin mb-2 text-right">
                                        <a href="{{ route('admin.logs.add', ['product_id' => $asset->product_id, 'asset_id' => $asset->laptop_id]) }}"
                                            target="_new">
