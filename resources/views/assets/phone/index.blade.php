        ...
        <div class="container-fluid">
            <div class="margin mb-2 text-right">
                <a href="{{ route('admin.phones.create') }}">
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Mobile Phone</button>
                </a>
            </div>
                            ...
                            @foreach ($assets as $asset)
                                <tr>
                                    ...
                                    <td>
                                        <div class="margin">
                                            <div class="btn-group">
                                                <a href="{{ route('admin.phones.edit', $asset->phone_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('admin.phones.show', $asset->phone_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <form action="{{ route('admin.phones.destroy', $asset->phone_id) }}"
                                                    method="post"
