        ...
        <div class="container-fluid">
            <div class="margin mb-2 text-right">
                <a href="{{ route('admin.scanners.create') }}">
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Scanner</button>
                </a>
            </div>
                            ...
                            @foreach ($assets as $asset)
                                <tr>
                                    ...
                                    <td>
                                        <div class="margin">
                                            <div class="btn-group">
                                                <a href="{{ route('admin.scanners.edit', $asset->scanner_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('admin.scanners.show', $asset->scanner_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <form action="{{ route('admin.scanners.destroy', $asset->scanner_id) }}"
                                                    method="post"
