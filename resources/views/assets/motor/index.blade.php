        ...
        <div class="container-fluid">
            <div class="margin mb-2 text-right">
                <a href="{{ route('admin.motors.create') }}">
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Motor</button>
                </a>
            </div>
                            ...
                            @foreach ($assets as $asset)
                                <tr>
                                    ...
                                    <td>
                                        <div class="margin">
                                            <div class="btn-group">
                                                <a href="{{ route('admin.motors.edit', $asset->motor_id) }}">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('admin.motors.show', $asset->motor_id) }}">
