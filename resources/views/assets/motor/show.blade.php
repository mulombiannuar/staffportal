                ...
                <div class="card-body">
                    <div class="tab-content">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="mileage" class="form-control" id="mileage"
                                                        value="{{ $asset->mileage }}" placeholder="Enter mileage"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="color" class="form-control" id="color"
                                                        value="{{ $asset->color }}" placeholder="Enter color"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="engine" class="form-control" id="engine"
                                                        value="{{ $asset->engine }}" placeholder="Enter engine details"
                                                        autocomplete="on" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="date" class="form-control" id="date"
                                                            value="{{ date('Y-m-d') }}" placeholder="Select date done"
                                                            autocomplete="on" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="cost" class="form-control" id="cost"
                                                            value="{{ old('cost') }}" placeholder="Enter fuel cost"
                                                            autocomplete="on" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="file">Receipt File <small class="text text-danger">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="margin">
                                                            ...
                                                            <div class="btn-group">
                                                                <form
                                                                    action="{{ route('admin.fuels.destroy', $fuel->fuel_id) }}"
                                                                    method="post"
                                                                    onclick="return confirm('Do you really want to delete this record?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                    ...
                                                    <!--/.modal begin -->
                                                    <div class="modal fade"
                                                        id="modalEditDetails-{{ $fuel->fuel_id }}" style="display: none;"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                        ...
                        <div class="tab-pane" id="maintenance">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fa fa-calendar"></i> Asset Maintenance Schedules
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <div class="margin mb-2 text-right">
                                        <a href="{{ route('admin.motor-logs.book', ['asset_id' => $asset->motor_id]) }}">
                                                    ...
                                                    <td>
                                                        <div class="margin">
                                                            @if ($log->status == 0)
                                                                <div class="btn-group">
                                                                    <a
                                                                        href="{{ route('admin.motor-logs.edit', $log->log_id) }}">
                                                                        <button type="button"
                                                                ...
                                                                <div class="btn-group">
                                                                    <form
                                                                        action="{{ route('admin.motor-logs.destroy', $log->log_id) }}"
                                                                        method="post"
                                                                        onclick="return confirm('Do you really want to delete this record?')">
                                                                        @csrf
                                                                        @method('DELETE')
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="client_phone" class="form-control"
                                                                id="client_phone" value="{{ $asset->mobile_no }}"
